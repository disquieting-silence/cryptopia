...
toLetter ch Black = Full { content: Data.String.toUpper $ Data.Char.toString ch, num: Nothing }
toLetter ch (Full d) = Full { content: Data.String.toUpper $ Data.Char.toString ch, num: d.num }
toLetter ch (Empty d) = Full { content: Data.String.toUpper $ Data.Char.toString ch, num: d.num }
